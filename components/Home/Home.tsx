...
import img from './../../public/aryasoni.png'
  ...
  return (
    <S.Container id="home">
      <S.HelloContainer>
        ...
        >
          <S.ContainerText>
          @Feetwings ( CTO ) | ML Enthusiast | SwiftUI
          </S.ContainerText>
        </ScrollAnimation>
        <ScrollAnimation
          animateIn="animate__flipInX"
        ...
        >
          <S.SocialsContainer>
            <S.SocialLink href="https://github.com/aryasoni98/" target="_blank">
              <Icon.GitHub />
            </S.SocialLink>
            <S.SocialLink
